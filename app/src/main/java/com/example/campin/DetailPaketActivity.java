...
public class DetailPaketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTNupdate         = findViewById(R.id.BTNUbahpaket);
        ...
        BTNImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DetailPaketActivity.this);
        ...
        BTNupdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(DetailPaketActivity.this)
                        .setMessage("Apakah anda ingin mengubah data ini?")
                        .setCancelable(false)
    ...
    public  void TakePhoto(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DetailPaketActivity.this);
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Memotret foto")) {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(DetailPaketActivity.this, authorities, photoFile);
                    ...
                    ActivityCompat.requestPermissions(DetailPaketActivity.this, new String[]
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(DetailPaketActivity.this, "Foto tidak dapat di potret!", Toast.LENGTH_SHORT).show();
            }
    ...
    void validatingData(){
        if(nama_paket.equals("") || jumlah_pertemuan.equals("") || harga.equals("") || mentor.equals("")){
            ...
            Toast.makeText(DetailPaketActivity.this, "Data tidak boleh kosong", Toast.LENGTH_SHORT).show();
        } else {
            updateData();
        }
    }
    ...
    void updateData(){
        ...
        AndroidNetworking.post("https://tekajeapunya.com/kelompok_11/carkus/updatepaket.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(DetailPaketActivity.this, "" + pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            ...
                            if (status) {
                                new AlertDialog.Builder(DetailPaketActivity.this)
                                        ...
                                        .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i = new Intent(DetailPaketActivity.this, PaketAdminActivity.class);
                                                startActivity(i);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_delete){
            new AlertDialog.Builder(DetailPaketActivity.this)
                    .setMessage("Apakah anda ingin menghapus data staf "+nama_paket+"?")
                    .setCancelable(false)
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            AndroidNetworking.post("https://tekajeapunya.com/kelompok_11/carkus/hapuspaket.php")
                                    .addBodyParameter("nama_paket",""+nama_paket)
                                    .setPriority(Priority.MEDIUM)
                                    .build()
                                    .getAsJSONObject(new JSONObjectRequestListener() {
                                        ...
                                        public void onResponse(JSONObject response) {
                                            ...
                                            try {
                                                ...
                                                if(status){
                                                    new AlertDialog.Builder(DetailPaketActivity.this)
                                                            .setMessage("Data Paket telah dihapus!")
                                                            .setCancelable(false)
                                                            .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                                                @Override
                                                                public void onClick(DialogInterface dialog, int which) {
                                                    ...
                                                    Toast.makeText(DetailPaketActivity.this, ""+result, Toast.LENGTH_SHORT).show();
                                                }
                                            }catch (Exception e){
                                                e.printStackTrace();
                                            }
