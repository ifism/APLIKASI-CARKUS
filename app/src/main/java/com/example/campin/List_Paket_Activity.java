...
public class List_Paket_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic_kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(List_Paket_Activity.this,BerandaActivity.class);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            if(status){
                                ...
                                final CLV_Paket adapter = new CLV_Paket(List_Paket_Activity.this,array_nama_paket,array_jumlah_pertemuan,
...
//                                });
                                ...
                                Toast.makeText(List_Paket_Activity.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
